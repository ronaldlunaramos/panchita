<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="{{route('admin.index')}}">  FACEA </a>
    </div>
    ...
    @if(Auth::user())
      <ul class="nav navbar-nav">
        ...
        @endif
        <li class=""><a href="{{route('admin.alumno.index')}}">ALUMNO <span class="sr-only">(current)</span></a></li>
        <li class=""><a href="{{route('admin.calificacion.index')}}">CALIFICACIÓN <span class="sr-only">(current)</span></a></li>
